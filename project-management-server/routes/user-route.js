...
router.post(`${environmentConfigs.userCollectionCreate}`, userController.validateHeaders(), userController.saveUsers)
router.post(`${environmentConfigs.userSignUpAction}`, userController.validateHeaders(), userController.saveUser)
...
router.put(`${environmentConfigs.userUpdateAction}`, userController.validateHeaders(), userController.updateUser)
